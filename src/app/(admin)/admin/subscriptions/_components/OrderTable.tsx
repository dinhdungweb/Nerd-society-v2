  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
      <Table dense striped>
        <TableHead>
          <TableRow>
            <TableHeader className="pl-8">Mã đơn</TableHeader>
        ...
        <TableBody>
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <TableRow key={i}>
                <TableCell className="pl-8"><div className="h-4 w-16 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" /></TableCell>
                <TableCell>
                ...
                <TableCell className="pr-8"><div className="ml-auto h-4 w-12 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" /></TableCell>
              </TableRow>
            ))
          ) : (
            orders.map((order) => (
              ...
              >
                <TableCell className="pl-8 font-mono text-xs font-medium text-neutral-500">{order.orderCode}</TableCell>
                <TableCell>
                  <div className="flex items-center gap-3">
                    <img 
