...
const navigation = {
    main: [
        ...
        { name: 'Góp ý', href: '/gop-y' },
        {
            ...
            children: [
                ...
                { name: 'Nerd Night', href: '/nerd-night' },
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/share/1D356XC4vj/?mibextid=wwXIfr',
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/nerdsociety.hn/?igsh=MWFjNHJmdHJwZHA1OQ%3D%3D',
            icon: (props: React.SVGProps<SVGSVGElement>) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'TikTok',
            href: 'https://www.tiktok.com/@nerdsocietyhn?_r=1&_t=ZS-92wxhBZv2qj',
            icon: (props: React.SVGProps<SVGSVGElement>) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
