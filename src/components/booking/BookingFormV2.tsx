        ...
        <div className="space-y-5 rounded-2xl bg-white p-6 shadow-sm dark:bg-neutral-900 relative">
            ...
            <div className="mt-8">
                ...
                <ul className="mt-3 space-y-1 text-xs text-neutral-500 dark:text-neutral-400">
                    ...
                    <li>• Bạn có thể huỷ đến ngay trước giờ bắt đầu; tiền cọc đủ điều kiện sẽ được hoàn tự động vào Ví Nerd.</li>
                    <li>• Đổi lịch cần thực hiện trước giờ bắt đầu 2 tiếng.</li>
                    <li>• Không đến và không huỷ booking: không hoàn tiền cọc.</li>
                </ul>
            </div>
        </div>
    )
