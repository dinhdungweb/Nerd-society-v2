...
export const ZALO_TEMPLATE_TYPES = [
  'CHECK_IN_SUB',
  'CHECK_IN_WALLET',
  'CHECK_OUT_SUB',
  'CHECK_OUT_WALLET',
...
const TEMPLATE_ENV_KEYS: Record<ZaloTemplateType, string> = {
  CHECK_IN_SUB: 'ZALO_ZBS_TEMPLATE_CHECK_IN_SUB',
  CHECK_IN_WALLET: 'ZALO_ZBS_TEMPLATE_CHECK_IN_WALLET',
  CHECK_OUT_SUB: 'ZALO_ZBS_TEMPLATE_CHECK_OUT_SUB',
  CHECK_OUT_WALLET: 'ZALO_ZBS_TEMPLATE_CHECK_OUT_WALLET',
  OVERAGE_WARNING: 'ZALO_ZBS_TEMPLATE_OVERAGE_WARNING',
  LOW_BALANCE: 'ZALO_ZBS_TEMPLATE_LOW_BALANCE',
  PAYMENT_RECEIVED: 'ZALO_ZBS_TEMPLATE_PAYMENT_RECEIVED',
  SUB_EXPIRING: 'ZALO_ZBS_TEMPLATE_SUB_EXPIRING',
  BLOCK_CHECKIN: 'ZALO_ZBS_TEMPLATE_BLOCK_CHECKIN',
}
